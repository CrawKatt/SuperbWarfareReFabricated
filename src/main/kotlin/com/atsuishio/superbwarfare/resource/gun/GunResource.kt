...
class GunResource private constructor(val id: String) {
    ...
    fun getDefault(): DefaultGunResource {
    ...
    companion object {
        ...
        fun idOf(stack: ItemStack): String {
            ...
            return if (gunItem == null || stack.isEmpty) {
                EmptyGunItem.EMPTY_GUN_ID
            } else {
                getRegistryId(stack.item)
            }
        }
