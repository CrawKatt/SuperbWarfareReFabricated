...
class GeHelmetM35Item :
    ArmorItem(ModArmorMaterials.STEEL, Type.HELMET, Properties().durability(Type.HELMET.getDurability(35))) {
    @EventBusSubscriber
    companion object {
                ...
                override fun getHumanoidArmorModel(
                    ...
                    if (this.renderer == null) {
                        this.renderer = GeoArmorRenderer(
                            BedrockModelLoader.getArmorModel(BedrockModelLoader.GE_HELMET_M_35_MODEL),
                            TEXTURE
                        )
                    }
