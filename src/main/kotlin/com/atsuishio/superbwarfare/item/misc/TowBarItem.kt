    ...
    companion object {
        ...
        fun init() {
            UseEntityCallback.EVENT.register callback@{ player, level, hand, originalTarget, _ ->
                ...
                val item = stack.item as? TowBarItem ?: return@callback InteractionResult.PASS
                ...
                if (level.isClientSide) {
                    ...
                    return@callback if (target is CatapultShuttleEntity || (target !is VehicleEntity && target !is LivingEntity && (player.isShiftKeyDown || selected))) {
            ...
            if (target is LivingEntity) {
                    ...
                    return@callback item.interactLivingEntity(stack, player, target, hand)
            }
