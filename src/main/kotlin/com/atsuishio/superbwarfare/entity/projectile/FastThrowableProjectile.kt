...
abstract class FastThrowableProjectile : ThrowableItemProjectile, CustomSyncMotionEntity, CustomSpawnDataEntity,
    ExplosiveProjectile {
    ...
    override fun onHitEntity(result: EntityHitResult) {
        ...
        ProjectileHitCallback.postHitEntity(
            HitEntity(
                this.owner,
                this,
                result.entity,
    ...
    override fun onHitBlock(result: BlockHitResult) {
        ...
        ProjectileHitCallback.postHitBlock(
            HitBlock(
                result.blockPos,
