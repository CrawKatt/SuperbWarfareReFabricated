...
enum class ModItemTier(
    ...
    STEEL(2, 400, 6.0f, 5.0f, 15, Supplier { Ingredient.of(ModItems.STEEL_INGOT) }),
    CEMENTED_CARBIDE(4, 2000, 8.0f, 8.0f, 18, Supplier { Ingredient.of(ModItems.CEMENTED_CARBIDE_INGOT) });
