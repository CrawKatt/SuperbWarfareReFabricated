...
class RPGMeleeExplosionTrigger : SimpleCriterionTrigger<RPGMeleeExplosionTrigger.TriggerInstance>() {
    ...
    data class TriggerInstance(val playerVar: Optional<ContextAwarePredicate>) : SimpleInstance {
        ...
        companion object {
            ...
            fun get(): Criterion<TriggerInstance> =
                ModCriteriaTriggers.RPG_MELEE_EXPLOSION.createCriterion(TriggerInstance(Optional.empty()))
        }
    }
}
