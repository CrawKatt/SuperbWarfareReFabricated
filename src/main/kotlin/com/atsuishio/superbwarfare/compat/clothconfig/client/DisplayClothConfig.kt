    ...
    fun init(root: ConfigBuilder, entryBuilder: ConfigEntryBuilder) {
        ...
        category.addEntry(
            entryBuilder
                ...
                .setSaveConsumer { DisplayConfig.ENABLE_GUN_LOD.set(it) }
        ...
        category.addEntry(
            entryBuilder
                ...
                .setDefaultValue(0)
                .setSaveConsumer { DisplayConfig.WEAPON_HUD_X_OFFSET.set(it) }
        ...
        category.addEntry(
            entryBuilder
                ...
                .setDefaultValue(0)
                .setSaveConsumer { DisplayConfig.WEAPON_HUD_Y_OFFSET.set(it) }
        ...
        category.addEntry(
            entryBuilder
                ...
                .setSaveConsumer { DisplayConfig.ENABLE_HEAT_BAR_HUD.set(it) }
        ...
        category.addEntry(
            entryBuilder
                ...
                .setDefaultValue(0)
                .setSaveConsumer { DisplayConfig.HEAT_BAR_HUD_X_OFFSET.set(it) }
        ...
        category.addEntry(
            entryBuilder
                ...
                .setDefaultValue(0)
                .setSaveConsumer { DisplayConfig.HEAT_BAR_HUD_Y_OFFSET.set(it) }
        ...
        category.addEntry(
            entryBuilder
                ...
                .setDefaultValue(true)
                .setSaveConsumer { DisplayConfig.KILL_INDICATION.set(it) }
        ...
        category.addEntry(
            entryBuilder
                ...
                .setDefaultValue(true)
                .setSaveConsumer { DisplayConfig.AMMO_HUD.set(it) }
        ...
        category.addEntry(
            entryBuilder
                ...
                .setDefaultValue(true)
                .setSaveConsumer { DisplayConfig.ADVANCED_AMMO_HUD.set(it) }
        ...
        category.addEntry(
            entryBuilder
                ...
                .setDefaultValue(true)
                .setSaveConsumer { DisplayConfig.VEHICLE_INFO.set(it) }
        ...
        category.addEntry(
            entryBuilder
                ...
                .setDefaultValue(true)
                .setSaveConsumer { DisplayConfig.FLOAT_CROSS_HAIR.set(it) }
        ...
        category.addEntry(
            entryBuilder
                ...
                .setDefaultValue(true)
                .setSaveConsumer { DisplayConfig.CAMERA_ROTATE.set(it) }
        ...
        category.addEntry(
            entryBuilder
                ...
                .setDefaultValue(true)
                .setSaveConsumer { DisplayConfig.ARMOR_PLATE_HUD.set(it) }
        ...
        category.addEntry(
            entryBuilder
                ...
                .setDefaultValue(true)
                .setSaveConsumer { DisplayConfig.STAMINA_HUD.set(it) }
        ...
        category.addEntry(
            entryBuilder
                ...
                .setDefaultValue(true)
                .setSaveConsumer { DisplayConfig.DOG_TAG_NAME_VISIBLE.set(it) }
        ...
        category.addEntry(
            entryBuilder
                ...
                .setDefaultValue(false)
                .setSaveConsumer { DisplayConfig.DOG_TAG_ICON_VISIBLE.set(it) }
        ...
        category.addEntry(
            entryBuilder
                ...
                .setDefaultValue(100)
                .setSaveConsumer { DisplayConfig.WEAPON_SCREEN_SHAKE.set(it) }
        ...
        category.addEntry(
            entryBuilder
                ...
                .setDefaultValue(100)
                .setSaveConsumer { DisplayConfig.EXPLOSION_SCREEN_SHAKE.set(it) }
        ...
        category.addEntry(
            entryBuilder
                ...
                .setDefaultValue(100)
                .setSaveConsumer { DisplayConfig.SHOCK_SCREEN_SHAKE.set(it) }
