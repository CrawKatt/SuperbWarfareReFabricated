...
fun registerClientReceivers() {
    ...
    clientReceiver<ModVersionSyncMessage>()
    ...
    clientReceiver<BeyondVisualEntitySyncMessage>()
    clientReceiver<ExplosionParticleMessage>()
    clientReceiver<MissileTrailParticleMessage>()
    clientReceiver<ShakeClientMessage>()
    clientReceiver<ShootClientMessage>()
    clientReceiver<SoundClientMessage>()
    clientReceiver<VehicleShootClientMessage>()
    clientReceiver<TDMSyncMessage>()
    clientReceiver<EntityRelationSyncMessage>()
    clientReceiver<PlayerInfoSyncMessage>()
    clientReceiver<RadarSyncMessage>()
    clientReceiver<ClientVehicleItemMessage>()
    clientReceiver<OpenVehicleSkinScreenMessage>()
    clientReceiver<OpenTacticalMapScreenMessage>()
}
...
fun registerPayloads() {
    ...
    playToClient<ModVersionSyncMessage>()
