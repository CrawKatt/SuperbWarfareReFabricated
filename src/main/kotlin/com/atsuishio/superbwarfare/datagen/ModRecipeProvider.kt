...
class ModRecipeProvider(pOutput: PackOutput) : RecipeProvider(pOutput) {
    ...
    companion object {
        ...
        private fun buildGunRecipes(writer: Consumer<FinishedRecipe>) {
            ...
            gunSmithing(writer, ModItems.GP_25_BLUEPRINT, GunRarity.EPIC, Items.DISPENSER, ModItems.GP_25)
        ...
        fun generatePerkResearchingRecipe(writer: Consumer<FinishedRecipe>, type: Perk.Type, rarity: Rarity) {
            val inputPerk: Item
        ...
        fun generatePerkRecycleResearchingRecipe(
            writer: Consumer<FinishedRecipe>,
            type: Perk.Type
        ) {
            val inputPerk: Item
        ...
        fun generateAttachmentResearchingRecipe(writer: Consumer<FinishedRecipe>, rarity: Rarity) {
            val input: Item
            val resTag: TagKey<Item>
