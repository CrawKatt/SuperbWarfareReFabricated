...
//            )
        ...
        fun perkLoc(perk: RegistryObject<Perk>): ResourceLocation {
        ...
        fun getPotionIngredient(potion: Potion): StrictNBTIngredient {
        ...
        fun generatePerkRecycleResearchingRecipe(writer: Consumer<FinishedRecipe>, type: Perk.Type) {
            val inputPerk: Item
            val resTag: TagKey<Item>
            when (type) {
                Perk.Type.AMMO -> {
