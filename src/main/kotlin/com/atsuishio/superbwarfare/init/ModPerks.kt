...
object ModPerks {
    ...
    private fun registerAmmoPerk(id: String, perk: () -> Perk): PERK {
        ...
        return Registry.register(PERK_REGISTRY, loc(id), perk()).also(AMMO_PERKS::add)
    }
    ...
    private fun registerFuncPerk(id: String, perk: () -> Perk): PERK {
        registeredIds.add(id)
        return Registry.register(PERK_REGISTRY, loc(id), perk()).also(FUNC_PERKS::add)
    }
    ...
    private fun registerDamagePerk(id: String, perk: () -> Perk): PERK {
        registeredIds.add(id)
        return Registry.register(PERK_REGISTRY, loc(id), perk()).also(DAMAGE_PERKS::add)
    }
    ...
    private fun autoRegisterFromJsons() {
        try {
            val perksDir = FabricLoader.getInstance().getModContainer(Mod.MODID)
                ...
                .orElseThrow { IllegalStateException("Missing built-in perk descriptors") }
