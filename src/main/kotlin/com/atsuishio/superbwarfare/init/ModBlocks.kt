...
object ModBlocks {
    val REGISTRY: DeferredRegister<Block> = DeferredRegister.create(ForgeRegistries.BLOCKS, Mod.MODID)
    ...
    fun registerBlock(name: String, block: () -> Block): RegistryObject<Block> {
