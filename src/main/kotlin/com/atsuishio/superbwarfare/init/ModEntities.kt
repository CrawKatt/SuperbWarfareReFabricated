...
object ModEntities {
    val REGISTRY: DeferredRegister<EntityType<*>> = DeferredRegister.create(ForgeRegistries.ENTITY_TYPES, Mod.MODID)
    ...
    val TARGET = register(
        ...
        EntityType.Builder.of(::TargetEntity, MobCategory.CREATURE)
            .setTrackingRange(64).setUpdateInterval(3).fireImmune().sized(0.875f, 2f)
    )
    ...
    val SENPAI = register(
        ...
        EntityType.Builder.of(::SenpaiEntity, MobCategory.MONSTER)
            .setTrackingRange(64).setUpdateInterval(3).sized(0.65f, 2f)
    )
    ...
    val CATAPULT_SHUTTLE = register(
        "catapult_shuttle",
        misc(::CatapultShuttleEntity).setTrackingRange(64).setUpdateInterval(1).sized(0.75f, 1.2f)
    )
