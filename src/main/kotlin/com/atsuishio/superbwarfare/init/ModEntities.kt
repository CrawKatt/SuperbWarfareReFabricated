...
object ModEntities {
    ...
    private fun <T : Entity> register(
        ...
        Registry.register(BuiltInRegistries.ENTITY_TYPE, Mod.loc(name), entityTypeBuilder.build(name))

    private fun <T : Entity> misc(
        entity: (EntityType<T>, Level) -> T
    ): EntityType.Builder<T> = EntityType.Builder.of(entity, MobCategory.MISC)

    private fun vehicle(): EntityType.Builder<VehicleEntity> = vehicle(::VehicleEntity)
