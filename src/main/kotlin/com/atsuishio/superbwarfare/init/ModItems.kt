...
object ModItems {
    ...
    @JvmField
    val BLOCKS: DeferredRegister<Item> = DeferredRegister.create(ForgeRegistries.ITEMS, Mod.MODID)
    ...
    // @formatter:off
    @JvmField val VEHICLES: DeferredRegister<Item> = DeferredRegister.create(ForgeRegistries.ITEMS, Mod.MODID)
