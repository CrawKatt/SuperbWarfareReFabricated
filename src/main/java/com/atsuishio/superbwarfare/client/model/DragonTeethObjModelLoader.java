...
public final class DragonTeethObjModelLoader {
    ...
    public static void register() {
        ModelLoadingPlugin.register(pluginContext -> {
            ...
            pluginContext.modifyModelAfterBake().register((bakedModel, context) -> {
                ...
                if (bakedModel == null || topLevelId == null || !BLOCK_ID.equals(topLevelId.id())
    ...
    private record ParsedObj(
        ...
        private void emitFace(
            ...
            for (int vertexIndex = 0; vertexIndex < 4; vertexIndex++) {
                ...
                emitter.uv(vertexIndex, sprite.getU(uv.x), sprite.getV(uv.y));
    ...
    private static void addFace(
        ...
        for (int index = 1; index < vertices.size() - 1; index++) {
            faces.add(new ObjFace(List.of(vertices.getFirst(), vertices.get(index), vertices.get(index + 1)), material));
        }
    }
    ...
    private static ResourceLocation relativeTo(ResourceLocation base, String path) {
        ...
        return ResourceLocation.fromNamespaceAndPath(base.getNamespace(), directory + path);
    }
