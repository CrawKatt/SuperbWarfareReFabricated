...
public class ModLootModifier {
    ...
    private static final ResourceLocation ANCIENT_BP = Mod.loc("chests/blue_print_ancient_cpu");
    ...
    public static void register() {
        LootTableEvents.MODIFY.register((resourceManager, lootManager, id, tableBuilder, source) -> {
            if (source.isBuiltin()) {
                ...
                addPoolIfTarget(id, tableBuilder, "stronghold_crossing", RARE_BP);
                addPoolIfTarget(id, tableBuilder, "stronghold_library", RARE_BP);
                addPoolIfTarget(id, tableBuilder, "stronghold_corridor", RARE_BP);

                addPoolIfTarget(id, tableBuilder, "end_city_treasure", EPIC_BP);

                addPoolIfTarget(id, tableBuilder, "ancient_city", ANCIENT_BP);
                addPoolIfTarget(id, tableBuilder, "ancient_city_ice_box", ANCIENT_BP);
            }
        });
    }
