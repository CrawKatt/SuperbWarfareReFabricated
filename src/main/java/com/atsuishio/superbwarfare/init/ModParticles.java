...
public class ModParticles {
    ...
    public static void register() {
        ParticleFactoryRegistry.getInstance().register(ModParticleTypes.FIRE_STAR.get(), FireStarParticle.FireStarParticleProvider::new);
        ParticleFactoryRegistry.getInstance().register(ModParticleTypes.RISING_SMOKE.get(), RisingSmokeParticle.RisingSmokeParticleProvider::new);
