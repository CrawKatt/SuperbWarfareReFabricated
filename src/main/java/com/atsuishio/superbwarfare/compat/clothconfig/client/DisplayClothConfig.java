...
public class DisplayClothConfig {
    ...
    public static void init(ConfigBuilder root, ConfigEntryBuilder entryBuilder) {
        ...
        category.addEntry(entryBuilder
                ...
                .setSaveConsumer(v -> { DisplayConfig.ENABLE_GUN_LOD.set(v); DisplayConfig.ENABLE_GUN_LOD.save(); })
        ...
        category.addEntry(entryBuilder
                .startIntSlider(Component.translatable("config.superbwarfare.client.display.weapon_hud_x_offset"), DisplayConfig.WEAPON_HUD_X_OFFSET.get(),
                        -1000, 1000)
                .setDefaultValue(0)
                .setSaveConsumer(v -> { DisplayConfig.WEAPON_HUD_X_OFFSET.set(v); DisplayConfig.WEAPON_HUD_X_OFFSET.save(); })
        ...
        category.addEntry(entryBuilder
                .startIntSlider(Component.translatable("config.superbwarfare.client.display.weapon_hud_y_offset"), DisplayConfig.WEAPON_HUD_Y_OFFSET.get(),
                        -1000, 1000)
                .setDefaultValue(0)
                .setSaveConsumer(v -> { DisplayConfig.WEAPON_HUD_Y_OFFSET.set(v); DisplayConfig.WEAPON_HUD_Y_OFFSET.save(); })
        ...
        category.addEntry(entryBuilder
                ...
                .setSaveConsumer(v -> { DisplayConfig.ENABLE_HEAT_BAR_HUD.set(v); DisplayConfig.ENABLE_HEAT_BAR_HUD.save(); })
        ...
        category.addEntry(entryBuilder
                .startIntSlider(Component.translatable("config.superbwarfare.client.display.heat_bar_hud_x_offset"), DisplayConfig.HEAT_BAR_HUD_X_OFFSET.get(),
                        -1000, 1000)
                .setDefaultValue(0)
                .setSaveConsumer(v -> { DisplayConfig.HEAT_BAR_HUD_X_OFFSET.set(v); DisplayConfig.HEAT_BAR_HUD_X_OFFSET.save(); })
        ...
        category.addEntry(entryBuilder
                .startIntSlider(Component.translatable("config.superbwarfare.client.display.heat_bar_hud_y_offset"), DisplayConfig.HEAT_BAR_HUD_Y_OFFSET.get(),
                        -1000, 1000)
                .setDefaultValue(0)
                .setSaveConsumer(v -> { DisplayConfig.HEAT_BAR_HUD_Y_OFFSET.set(v); DisplayConfig.HEAT_BAR_HUD_Y_OFFSET.save(); })
        ...
        category.addEntry(entryBuilder
                ...
                .setDefaultValue(true)
                .setSaveConsumer(v -> { DisplayConfig.KILL_INDICATION.set(v); DisplayConfig.KILL_INDICATION.save(); })
        ...
        category.addEntry(entryBuilder
                ...
                .setDefaultValue(true)
                .setSaveConsumer(v -> { DisplayConfig.AMMO_HUD.set(v); DisplayConfig.AMMO_HUD.save(); })
        ...
        category.addEntry(entryBuilder
                ...
                .setDefaultValue(true)
                .setSaveConsumer(v -> { DisplayConfig.ADVANCED_AMMO_HUD.set(v); DisplayConfig.ADVANCED_AMMO_HUD.save(); })
        ...
        category.addEntry(entryBuilder
                ...
                .setDefaultValue(true)
                .setSaveConsumer(v -> { DisplayConfig.VEHICLE_INFO.set(v); DisplayConfig.VEHICLE_INFO.save(); })
        ...
        category.addEntry(entryBuilder
                ...
                .setDefaultValue(true)
                .setSaveConsumer(v -> { DisplayConfig.FLOAT_CROSS_HAIR.set(v); DisplayConfig.FLOAT_CROSS_HAIR.save(); })
        ...
        category.addEntry(entryBuilder
                ...
                .setDefaultValue(true)
                .setSaveConsumer(v -> { DisplayConfig.CAMERA_ROTATE.set(v); DisplayConfig.CAMERA_ROTATE.save(); })
        ...
        category.addEntry(entryBuilder
                ...
                .setDefaultValue(true)
                .setSaveConsumer(v -> { DisplayConfig.ARMOR_PLATE_HUD.set(v); DisplayConfig.ARMOR_PLATE_HUD.save(); })
        ...
        category.addEntry(entryBuilder
                ...
                .setDefaultValue(true)
                .setSaveConsumer(v -> { DisplayConfig.STAMINA_HUD.set(v); DisplayConfig.STAMINA_HUD.save(); })
        ...
        category.addEntry(entryBuilder
                ...
                .setDefaultValue(true)
                .setSaveConsumer(v -> { DisplayConfig.DOG_TAG_NAME_VISIBLE.set(v); DisplayConfig.DOG_TAG_NAME_VISIBLE.save(); })
        ...
        category.addEntry(entryBuilder
                ...
                .setDefaultValue(false)
                .setSaveConsumer(v -> { DisplayConfig.DOG_TAG_ICON_VISIBLE.set(v); DisplayConfig.DOG_TAG_ICON_VISIBLE.save(); })
        ...
        category.addEntry(entryBuilder
                .startIntSlider(Component.translatable("config.superbwarfare.client.display.weapon_screen_shake"), DisplayConfig.WEAPON_SCREEN_SHAKE.get(),
                        0, 100)
                .setDefaultValue(100)
                .setSaveConsumer(v -> { DisplayConfig.WEAPON_SCREEN_SHAKE.set(v); DisplayConfig.WEAPON_SCREEN_SHAKE.save(); })
        ...
        category.addEntry(entryBuilder
                .startIntSlider(Component.translatable("config.superbwarfare.client.display.explosion_screen_shake"), DisplayConfig.EXPLOSION_SCREEN_SHAKE.get(),
                        0, 100)
                .setDefaultValue(100)
                .setSaveConsumer(v -> { DisplayConfig.EXPLOSION_SCREEN_SHAKE.set(v); DisplayConfig.EXPLOSION_SCREEN_SHAKE.save(); })
        ...
        category.addEntry(entryBuilder
                .startIntSlider(Component.translatable("config.superbwarfare.client.display.shock_screen_shake"), DisplayConfig.SHOCK_SCREEN_SHAKE.get(),
                        0, 100)
                .setDefaultValue(100)
                .setSaveConsumer(v -> { DisplayConfig.SHOCK_SCREEN_SHAKE.set(v); DisplayConfig.SHOCK_SCREEN_SHAKE.save(); })
