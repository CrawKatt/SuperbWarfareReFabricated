...
public class SodayoPickUpRocketEntity extends ArtilleryEntity {
    public static final EntityDataAccessor<List<Integer>> LOADED_AMMO = SynchedEntityData.defineId(SodayoPickUpRocketEntity.class, ModSerializers.INT_LIST_SERIALIZER);
    public OBB body1;
    public OBB body2;
    public OBB body3;
